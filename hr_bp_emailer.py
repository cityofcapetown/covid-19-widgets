...
DIRECTORATE_DETAILS_DICT = {
    ...
    #      "cc_email": HR_CREW + ["Lele.Sithole@capetown.gov.za"]},
    "FINANCE":
        {"receiver_name": ["Tembekile", "Danie", "Petro", "Bertie"],
         "receiver_email": ["Tembekile.Solanga@capetown.gov.za", "JanDaniel.Malan@capetown.gov.za", "Petro.Rheeder@capetown.gov.za", "Bertie.vanNiekerk@capetown.gov.za"],
         "cc_email": HR_CREW + ["Lele.Sithole@capetown.gov.za"]},
    # "CORPORATE SERVICES":
