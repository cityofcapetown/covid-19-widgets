...
DIRECTORATE_DETAILS_DICT = {
    ...
    #      "cc_email": HR_CREW + ["Lele.Sithole@capetown.gov.za"]},
    "FINANCE":
        {"receiver_name": ["Tembekile", "Louise", "Petro"],
         "receiver_email": ["Tembekile.Solanga@capetown.gov.za", "Louise.Muller@capetown.gov.za", "Petro.Rheeder@capetown.gov.za"],
         "cc_email": HR_CREW + ["Lele.Sithole@capetown.gov.za"]},
    # "CORPORATE SERVICES":
    ...
    "HUMAN SETTLEMENTS":
        {"receiver_name": ["Andre"],
         "receiver_email": ["Andre.Kermis@capetown.gov.za"],
         "cc_email": HR_CREW + ["Lele.Sithole@capetown.gov.za"]},
    # "HUMAN SETTLEMENTS":
    #     {"receiver_name": ["Gordon"],
    #      "receiver_email": ["gordon.inggs@capetown.gov.za"],
