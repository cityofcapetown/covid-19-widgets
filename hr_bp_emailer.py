...
DIRECTORATE_DETAILS_DICT = {
    ...
    #      "cc_email": HR_CREW + ["Lele.Sithole@capetown.gov.za"]},
    "FINANCE":
        {"receiver_name": ["Tembekile", "Louise", "Gillian", "Petro", "Danie"],
         "receiver_email": ["Tembekile.Solanga@capetown.gov.za", "Louise.Muller@capetown.gov.za", "Gillian.Meyer@capetown.gov.za", "Petro.Rheeder@capetown.gov.za", "Danie.Malan@capetown.gov.za"],
         "cc_email": HR_CREW + ["Lele.Sithole@capetown.gov.za"]},
    # "CORPORATE SERVICES":
