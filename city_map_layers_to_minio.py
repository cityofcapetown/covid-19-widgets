...
LAYER_FILES = (
    ("informal_settlements.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_PUBLIC_PREFIX),
    ...
    ("wcpg_testing_facilities.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("sl_du_pop_est_2019_hex9.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("province_sevi_v2_hex9.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("wced_metro_schools_2019.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("retail_stores.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("shopping_centres_above_5000sqm_rode_2020.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("public_transport_interchanges.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("public_transport_activity_levels_hex9.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("trading_location.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("sassa_local_office_coc.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ...
    ("hdx_pop_estimates_elderly_hex9.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("adult_homeless_shelters_coct.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("employment_density_survey_hex7.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("hh_emp_incomegrp_sp_tz2018_hex8.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("combined_senior_citizens_layer.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("cpop_gt55.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ("employment_density_survey_20200515.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
    ...
    ("coct_cbt_v2.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_COMMUNITY_RESPONSE_PREFIX),
    ("ct_cans.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_COMMUNITY_RESPONSE_PREFIX),
    ("npo_publish_data.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_COMMUNITY_RESPONSE_PREFIX),
    ...
    ("community-organisations-environment.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-safety-and-security-organisations.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-sports.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-civic-based-organisations.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-business.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-youth.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-arts-and-culture.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-education.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-faith-based-organisations.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ("community-organisations-designated-vulnerable-groups.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COD_BUCKET, ""),
    ...
    ("infrastructure_projects.geojson", MINIO_EDGE_CLASSIFICATION, MINIO_COVID_BUCKET, DATA_VULNERABILITY_PREFIX),
)


def get_layers(tempdir, minio_edge_access, minio_edge_secret, layers=LAYER_FILES,
               minio_lake_access=None, minio_lake_secret=None):
