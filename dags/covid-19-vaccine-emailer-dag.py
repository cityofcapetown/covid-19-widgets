...
def covid_19_widget_task(task_name, task_args, task_kwargs={}):
    ...
    run_cmd = f"bash -c '{startup_cmd} && \"$COVID_19_WIDGETS_DIR\"/bin/{task_name}.sh --report_date {task_args}"
...
vaccine_email_operator = covid_19_widget_task(VACCINE_EMAIL_TASK, report_date)
